...
query = "SELECT SongId, ProcessedLyrics FROM songs where SongId = 24182;"
...
for index, row in df.iterrows(): 
    ...
    with connection.cursor() as cursor:
       sql = "INSERT INTO ComplexityIndex2 (SongId,SentenceCount,WordCount,AvgSyllablesPerWord,AvgSentenceLength,DifficultWordCount,SyllableCount,GunningFog,PolySyllable,SmogIndex,DaleChall,Flesch) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) "   
